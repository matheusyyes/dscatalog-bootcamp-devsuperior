                ...
                <div className="row">
                    ...
                    <div className="col-6 product-details-card">
                        ...
                        <p className="product-description-text">
                            ...
                            Crie áreas de trabalho virtuais para obter mais espaço e trabalhar com os itens que
                            você deseja. Além disso, todas as notificações e principais configurações são reunidas
